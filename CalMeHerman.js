//UDAH DI KASIH YANG NO ENC MASIH BELUM/SCRIBE? PARAH SI
	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `iago Chanel`,"description": "iago o brabo do momento", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "ItsMeBotz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
ᱝ *User :* ${pushname}
`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'MENUS😈'},type:1},{buttonId: `${prefix}vn`,buttonText:{displayText: 'MENU DE ÁUDIO🗣️'},type:1}]
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               ...
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Dewasa Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`,`STICKER MENU`,`DOWNLOAD MENU`,`OWNER MENU`,`NOVIDADES`,`GAME MENU`,`GRUP MENU`,`WIBU MENU`]
               nombor = 1
               startnum = 0
       ...
       case 'othercmd':
               ...
               const yy = {title: 'Silahkan di pilih' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        footerText: 'case by iago', imageMessage: imageMsg,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
               ...
               listmsg(from, `${ucapanWaktu}`,   `INSCREVA SE https://youtu.be/gylOwJD5kCM`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
if (vit == "derrota" ) {
var tes = "A vitória é do NT DRAGON"
}
if (vit == "empate" ) {
...
reply('_[ ! ] Música não encontrada._')
})
...
sendFileFromUrl(res.all[0].image, image, {quoted: mek, caption: thumbInfo})
res = await y2mateA(res.all[0].url).catch(e => {
reply('_[ ! ] Música não encontrada_')
})
sendFileFromUrl(res[0].link, document, {quoted: mek, mimetype: 'audio/mp3', filename: res[0].output})
}
break
...
*[Wait] Tunggu Sebentar..*`
				...
				dha.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:freply, caption: 'Nih Gan'})
					break  
				case 'play':
              if (!q) return reply('Qual o nome da música que você está procurando?')
              buttons = [{buttonId: `${prefix}play2 ${q}`,buttonText:{displayText: `🎥 Video`},type:1},{buttonId:`${prefix}playy ${q}`,buttonText:{displayText:'🎵 MUSICA'},type:1}]
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *iago o brabo do momento* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(_.jid, 
			...
			"buttonText": {"displayText": "LISTA MENU"
			},"type": "RESPONSE"}
			], "headerType": 1,
...
//------------------< Lainnya >-------------------
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
               thankslort = `*[━━━━ INFO BOT ━━━━]*\n*➤ Nama : NT DRAGON*\n*➤ Pukul : ${moment().utcOffset('+0700').format('HH:mm')}*\n*➤ Encontro : ${moment.tz('Asia/Jakarta').format('DD/MM')}*\n*➤ Tipo : PC*\n*➤ Version : 9.9.9.9*\n*[━━━━━━━━━━━━━━━━━━]*`
...
if (!isOwner) if (budy.includes("fuder NT DRAGON") || (budy.includes("fuder NT DRAGON") || (budy.includes("fude NT DRAGON") || (budy.includes("fude NT DRAGON") || (budy.includes("estuprar NT DRAGON") || (budy.includes("estuprar NT DRAGON") ||(budy.includes("fdp NT DRAGON")))))))){
...
if (!isOwner) if (budy.includes("NT DRAGON puta")){
random = Math.floor(Math.random() * 4) + 1
if (ram == 1 ) {random = 'sua ameba irritante'} else if (ram == 2 ) {random = 'seu inseto insolente!'} else if (ram == 3 ) {random = 'humano patético'} else if (ram == 4 ) {random = 'sua opinião é irrelevante'} 
...
if (!isOwner) if (budy.includes("NT DRAGON puta") || (budy.includes("NT DRAGON sua puta") || (budy.includes("NT DRAGON sua puta") || (budy.includes("NT DRAGON sua vadia") || (budy.includes("NT DRAGON sua vadia") || (budy.includes("puta NT DRAGON") ||(budy.includes("puta NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
if (ram == 1 ) {random = 'sua ameba irritante'} else if (ram == 2 ) {random = 'seu inseto insolente!'} else if (ram == 3 ) {random = 'humano patético'} else if (ram == 4 ) {random = 'sua opinião é irrelevante'} 
...
if (!isOwner) if (budy.includes("vadia NT DRAGON") || (budy.includes("vadia NT DRAGON") || (budy.includes("NT DRAGON sua feia") || (budy.includes("NT DRAGON sua feia") || (budy.includes("bot lixo") || (budy.includes("lixo de bot") ||(budy.includes("pau NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
if (ram == 1 ) {random = 'sua ameba irritante'} else if (ram == 2 ) {random = 'seu inseto insolente!'} else if (ram == 3 ) {random = 'humano patético'} else if (ram == 4 ) {random = 'sua opinião é irrelevante'} 
...
if (!isOwner) if (budy.includes("NT DRAGON chupa") || (budy.includes("NT DRAGON chupa") || (budy.includes("pau NT DRAGON") || (budy.includes("NT DRAGON mama") || (budy.includes("NT DRAGON mama") || (budy.includes("mama NT DRAGON") ||(budy.includes("mama NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
if (ram == 1 ) {random = 'sua ameba irritante'} else if (ram == 2 ) {random = 'seu inseto insolente!'} else if (ram == 3 ) {random = 'humano patético'} else if (ram == 4 ) {random = 'sua opinião é irrelevante'} 
...
if (!isOwner) if (budy.includes("comer NT DRAGON") || (budy.includes("comer NT DRAGON") || (budy.includes("NT DRAGON sua filha") || (budy.includes("NT DRAGON sua filha") || (budy.includes("matar NT DRAGON") || (budy.includes("matar NT DRAGON") ||(budy.includes("piroca NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
if (ram == 1 ) {random = 'sua ameba irritante'} else if (ram == 2 ) {random = 'seu inseto insolente!'} else if (ram == 3 ) {random = 'humano patético'} else if (ram == 4 ) {random = 'sua opinião é irrelevante'} 
...
if (!isOwner) if (budy.includes("cu NT DRAGON") || (budy.includes("cu NT DRAGON") || (budy.includes("cu bot") || (budy.includes("cú NT DRAGON") || (budy.includes("cú NT DRAGON") || (budy.includes("NT DRAGON vai tomar") ||(budy.includes("NT DRAGON vai tomar")))))))){
random = Math.floor(Math.random() * 4) + 1
...
if (budy.includes("NT DRAGON sua lindo") || (budy.includes("NT DRAGON sua lindo") || (budy.includes("NT DRAGON lindo") || (budy.includes("NT DRAGON lindo") || (budy.includes("lindo NT DRAGON") || (budy.includes("lindo NT DRAGON") ||(budy.includes("NT DRAGON gostoso")))))))){
random = Math.floor(Math.random() * 4) + 1

ram = random
if (ram == 1 ) {random = '👉👈 obrigado'} else if (ram == 2 ) {random = 'owwn vlw, humano'} else if (ram == 3 ) {random = 'assim eu fico tímido ｡◕‿◕｡'} else if (ram == 4 ) {random ='fofo, não vou te matar'} 
...
if (!isOwner) if (budy.includes("NT DRAGON gostoso") || (budy.includes("NT DRAGON sua gotosa") || (budy.includes("NT DRAGON sua gostoso") || (budy.includes("gostoso NT DRAGON") || (budy.includes("gostoso NT DRAGON") || (budy.includes("foda NT DRAGON") ||(budy.includes("foda NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
...
if (budy.includes("NT DRAGON é foda") || (budy.includes("fofo NT DRAGON") || (budy.includes("NT DRAGON é foda") || (budy.includes("NT DRAGON e foda") || (budy.includes("NT DRAGON e foda") || (budy.includes("fofo NT DRAGON") ||(budy.includes("NT DRAGON fofo")))))))){
random = Math.floor(Math.random() * 4) + 1
...
if (budy.includes("NT DRAGON fofo") || (budy.includes("amor NT DRAGON") || (budy.includes("amor NT DRAGON") || (budy.includes("bonita NT DRAGON") || (budy.includes("bonita NT DRAGON") || (budy.includes("NT DRAGON é legal") ||(budy.includes("legal NT DRAGON")))))))){
random = Math.floor(Math.random() * 4) + 1
...
teks = `Ola @${senderr.split('@')[0]}, comando ${prefix + command} não achado no menu`
